...
public class UserDetail extends User
{
	 ...
	 */
	private String type;	//brand,celebrity,user
	/**
	...
	/**
	 * Contains the count of badges for this user. 
	 * May eventually contain some selected badges. 
	 * Use user/XX/badges to get the list of badges.
	 */
	private Items<Badge> badges;		//only returns a count
	/**
	...
	/**
	 * 	Contains the count of mayorships for this user. 
	 * If there are any mayorships, may contain an array of selected mayorships as items, which may or may not be empty. 
	 */
	 ...
	 */
	public void setBadges(Items<Badge> badges)
	{
		this.badges = badges;
	}
	/**
	 ...
	 * @return the friends
	 */
	public Groups<Object> getFriends()
	{
		return friends;
	}
	/**
	 ...
	 */
	public void setFriends(Groups<Object> friends)
	{
